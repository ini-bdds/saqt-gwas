...
linear_assoc_manhattan_plot <- function(location, phenotype) {
	...
	manhattanly(pvaldata, point_size = 3, suggestiveline = -log10(1e-06), genomewideline = -log10(5e-08), snp = "SNP", gene = "GeneSymbol", annotation1 = "GeneLocation", annotation2 = "QT")
}
...
combined_linear_assoc_manhattan_plot <- function(location) {
	...
	manhattanly(combined, point_size = 3, suggestiveline = -log10(1e-06), genomewideline = -log10(5e-08), snp = "SNP", gene = "GeneSymbol", annotation1 = "GeneLocation", annotation2 = "QT")
}
...
logistic_assoc_manhattan_plot <- function(location) {
	...
	manhattanly(pvaldata, point_size = 3, suggestiveline = -log10(1e-06), genomewideline = -log10(5e-08), snp = "SNP", gene = "GeneSymbol", annotation1 = "GeneLocation")
}
...
phe_by_groups <- function(location, phenotype) {
	...
	plot_ly(phe_with_groups, y = ~PHE, color = ~Screen.Diagnosis, type = "box")
}
